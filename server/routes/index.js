...
router.get('/resume', sql.resume.quary)
router.post('/resume', sql.resume.insert)
router.get('/userstatus',sql.userstatus.update)
router.get('/userstatus',sql.userstatus.quary)
